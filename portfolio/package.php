...
<section class="packages">
   ...
   <h1 class="heading-title">Playing Areas</h1>
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <div class="content">
            <h3>Fun Fusion Park</h3>
            <p>Location<b></b>: Gachie, Kiambu County<br>
               Type of Activities: Outdoor<br>
